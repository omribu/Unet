...
def pred_show_image_grid(data_path, model_pth, device):
    ...
    image_dataset = DataSets(data_path, test=True)
    images = []
    orig_masks = []
    pred_masks = []
...
if __name__ == "__main__":
    SINGLE_IMG_PATH = "/home/omri/Downloads/img/img.jpg"
    DATA_PATH = "/home/omri/Unet/data/plowing"
    MODEL_PATH = "/home/omri/Unet/models/unet.pth"
